...
import com.joesemper.fishing.adapters.CatchRecyclerViewItem
import com.joesemper.fishing.adapters.UserCatchesRVAdapter
        ...
        adapter = UserCatchesRVAdapter { item ->
            when (item) {
                ...
                is CatchRecyclerViewItem.ItemUserCatch -> {
                    val action =
                        com.joesemper.fishing.fragments.MapFragmentDirections.actionMapFragmentToUserCatchFragment(
                            item.catch
                        )
                    findNavController().navigate(action)
                }
