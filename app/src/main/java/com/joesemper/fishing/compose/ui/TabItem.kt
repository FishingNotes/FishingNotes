...
sealed class TabItem(var icon: Int, var title: String, var screen: ComposableFun) {
    ...
    object Places : TabItem(R.drawable.ic_baseline_location_on_24, "Places", { UserPlacesLoading({}) })

    @ExperimentalAnimationApi
    object Catches : TabItem(R.drawable.ic_add_catch, "Catches", { UserCatchesLoading({}) })
