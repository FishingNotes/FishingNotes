...
import com.joesemper.fishing.presentation.map.dialogs.marker.catches.adapters.CatchRecyclerViewItem
import com.joesemper.fishing.presentation.map.dialogs.marker.catches.adapters.UserCatchesRVAdapter
        ...
        adapter = UserCatchesRVAdapter { item ->
            when (item) {
                is CatchRecyclerViewItem.ItemAddNewCatch -> {
                    val action =
                        MapFragmentDirections.actionMapFragmentToNewCatchDialogFragment(marker)
